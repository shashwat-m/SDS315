...
## Part A
```{r message=FALSE, echo=FALSE, warning=FALSE, output = FALSE}
...
To estimate the price elasticity of demand for milk, we fit a log-log linear model of log(sales) on log(price), consistent with a power-law demand model.
